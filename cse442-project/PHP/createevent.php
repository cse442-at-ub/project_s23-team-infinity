<?php
        ...
        echo "<br>",$timeStart, " TYPE: ", gettype($timeStart);
        echo "<br>",$timeEnd, " TYPE: ", gettype($timeEnd);
        ...
        if (strlen(trim($username)) == 0 or strlen(trim($title)) == 0) {
            ...
            if ($userID > 0) {
                ...
                /*
                $eventquery = "INSERT INTO $tablename VALUES (NULL, '$userID', '$title', '$date', '$timeStart', '$timeEnd', '$location', '$notes')";
                try {
